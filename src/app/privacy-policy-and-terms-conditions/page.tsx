...
export const metadata: Metadata = {
  ...
  description:
    "Terms & Conditions and Privacy Notice for the Hero Destini Fantasy World campaign by Hero MotoCorp Limited.",
};
  ...
  return (
    <main className="min-h-dvh bg-white text-ink">
      <div className="mx-auto max-w-3xl px-5 py-8 sm:px-8 sm:py-12">
        ...
        {/* Sections — one continuous document, no in-page navigation */}
